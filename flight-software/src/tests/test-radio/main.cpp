...
const int irqPin = A4;         // change for your board; must be a hardware interrupt pin
...
//   byte ver = SPI.transfer(0x42);  // read version register
//   digitalWrite(csPin, HIGH);
//   Serial.println(ver, HEX);  // should be 0x12 for RFM95W/SX1276
//   delay(1000);
// }
